...
int func_2()
{
	...
	if (!unk_0xD6F9DEE4765092A9(&cLocal_80))
	{
		if (!unk_0x9CFFB7009B578840(uLocal_77))
		{
			Var0 = { Vector(32.856f, 3819.65f, 1971.62f) - Local_75 };
			uLocal_77 = unk_0x56E8A6AA712B10C2(&cLocal_80, Local_75 + Var0, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
		}
	}
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		if (unk_0x13CCB1AD131C1082(unk_0x4A8C381C258A124D(), &sLocal_110, &cLocal_126, 2))
		{
			...
			switch (iLocal_170)
			{
				case 0:
					...
					if (fVar1 > fLocal_108)
					{
						if (!unk_0xFC8BFE4B41177C22(iLocal_68) || iLocal_79 != -1)
						{
							if (unk_0x5B5B2AE530F511CC(&cLocal_89, unk_0x4A8C381C258A124D(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_79, 1f, 0, 0, 0))
							{
								if (unk_0x1B79E937E91F40C3(&cLocal_89, "scr_meth_pipe_smoke"))
								{
									func_17(unk_0x4A8C381C258A124D(), 0, 1, 0, -1);
								}
								uLocal_169 = unk_0xCA369FBC0DE29517();
								unk_0xBD618A73193F9982(uLocal_169, &cLocal_160, unk_0x4A8C381C258A124D(), &cLocal_151, 0, 0);
								iLocal_170++;
							}
						}
						else if (unk_0xDD19F75405614D3C(&cLocal_89, iLocal_68, 0f, 0f, -1f, 0f, 0f, 0f, 1065353216, 0, 0, 0))
						{
							if (unk_0x1B79E937E91F40C3(&cLocal_89, "scr_meth_pipe_smoke"))
							{
								func_17(unk_0x4A8C381C258A124D(), 0, 1, 0, -1);
				...
				case 2:
					if (!unk_0xD6F9DEE4765092A9(&cLocal_98))
					{
						if (unk_0xE56FEB6B12B5A32C(&cLocal_98, Local_75 + Local_107, 0f, 0f, 0f, 1f, 0, 0, 0))
						{
							iLocal_170++;
						}
					}
			...
			{
				if (unk_0xA3736D76B0E93E93(iLocal_68))
				{
					if (iLocal_74 != -1)
					{
						if (fVar1 > fLocal_73)
		...
		else
		{
			if (iLocal_78 != 0)
			{
				unk_0x182120534CCF9023(iLocal_78, 0);
				iLocal_78 = 0;
				unk_0x8E4825CCACA34B58(uLocal_169);
				unk_0x394AFAC073E1F277(uLocal_169);
			}
			if (unk_0xFC8BFE4B41177C22(iLocal_68))
			{
				if (unk_0xA3736D76B0E93E93(iLocal_68))
...
int func_37()
{
	if (!iLocal_69 == 0)
	{
		if (!unk_0xFC8BFE4B41177C22(iLocal_68))
		{
			...
			{
				iLocal_68 = unk_0x4E55EAB577C13329(iLocal_69, Local_75, 1, 1, 0);
				unk_0x4D306DD94DD6FDBA(iLocal_68, unk_0x4A8C381C258A124D(), unk_0x72F7E39FB49FC0BA(unk_0x4A8C381C258A124D(), iLocal_72), Local_70, Local_71, 0, 0, 0, 0, 2, 1, 0);
			}
			else
			{
				iLocal_68 = unk_0x4E55EAB577C13329(iLocal_69, Local_75 + Local_70, 1, 1, 0);
				unk_0xB2BD5837A8D3CEDA(iLocal_68, Local_75 + Local_70, 1, 0, 0, 1);
				unk_0xCF39804E8C88080E(iLocal_68, Vector(uLocal_76, 0f, 0f) + Local_71, 2, 1);
				unk_0x5D7CD709B34C90F0(iLocal_68, 1);
			}
		}
	}
	if (!func_38())
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_68))
		{
			if (iLocal_72 != -1)
			{
				if (!unk_0x21478251925DBFD7(iLocal_68, unk_0x4A8C381C258A124D()))
				{
					unk_0x4D306DD94DD6FDBA(iLocal_68, unk_0x4A8C381C258A124D(), unk_0x72F7E39FB49FC0BA(unk_0x4A8C381C258A124D(), iLocal_72), Local_70, Local_71, 0, 0, 0, 0, 2, 1, 0);
				}
			}
...
void func_53()
{
	...
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (!unk_0xD6F9DEE4765092A9(&cLocal_142))
		{
			if (!unk_0x91476A70AA1CB09A(&cLocal_142, 0, -1))
			{
				bVar1 = false;
			}
		}
