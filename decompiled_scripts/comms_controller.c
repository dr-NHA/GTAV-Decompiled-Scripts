...
void func_40()
{
	...
	iVar1 = ceil((unk_0x0B852B0BF94A8DC1() * 1000f));
...
int func_107()
{
	...
	{
		fVar0 = vdist2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), func_108(212, 0));
		if (fVar0 > 22500f)
		{
			Global_95683 = -1;
			return 1;
...
int func_118()
{
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		if (vdist2(func_108(181, 0), unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)) > 40000f)
		{
			return 1;
		}
	}
