					...
					else
					{
						if (iLocal_42)
						{
							...
							while (iLocal_44 < 8)
							{
								...
								{
									if (func_38(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), iLocal_44 + 1, 0, 0))
									{
						...
						if (timera() > 125)
						{
							...
							if (func_35(bLocal_37, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0)))
							{
								...
								if (func_34(bLocal_37))
								{
									...
									if (unk_0x486FF5D06E9659F1(unk_0x70E57E9927B6BA58(&Local_48)) == 0)
									{
								...
								else if (!Global_32379[bLocal_37])
								{
									if (unk_0x1F7A48429F9F64CE(unk_0x4A8C381C258A124D()))
									{
										...
										if (!bLocal_40)
										{
											if (func_38(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), bLocal_37, 0, 0))
											{
												if ((unk_0x1DD05E817C89C737() - iLocal_49[iLocal_46]) > 8000)
												{
													func_24();
												}
											...
											{
												iLocal_49[iLocal_46] = unk_0x1DD05E817C89C737();
											}
										}
									}
									else
									{
										...
										if (!bLocal_40)
										{
											if (func_38(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), bLocal_37, 0, 0))
											{
												if (!bLocal_37 == 4 || (unk_0x1DD05E817C89C737() - iLocal_49[iLocal_46]) > 8000)
												{
													func_24();
												}
											}
...
void func_24()
{
	switch (iLocal_46)
	{
		case 0:
			iLocal_47 = 2;
			if (unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) < iLocal_47)
			{
			}
			break;
	...
	if (unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) < iLocal_47)
	{
		unk_0xE20A252886E4FE1D(unk_0x259BE71D8A81D4FA(), iLocal_47, 0);
