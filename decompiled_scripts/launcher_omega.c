...
void func_189(int iParam0)
{
	...
	if ((unk_0x1DD05E817C89C737() - iLocal_58) > 1250)
	{
...
void func_191()
{
	...
	unk_0x88F483FBD433696A(uLocal_56, "SET_COLOUR");
	...
	unk_0x88F483FBD433696A(uLocal_56, "SET_DISTANCE");
	unk_0x74BF156C860580D4(10f);
	unk_0xE6B753D52F4CA222();
	unk_0x61055542D9D877AE(uLocal_57);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x6D16B99FEB0AFFF1(uLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x1DD05E817C89C737() - iLocal_58) > 1250)
	{
		unk_0xF37CDE164C892195(uLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_58 = unk_0x1DD05E817C89C737();
	}
}
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	...
	if (!*uParam6 == 3)
	{
		if (func_180(2))
		{
			...
			if (func_199(unk_0x4A8C381C258A124D(), Param1, 1) < 20f && *uParam6 == 1)
			{
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_228(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_247()
{
	uLocal_56 = unk_0x8DE4F68A9728925E("digiscanner");
	while (!unk_0xA0C7B98BCF1EEF9E(uLocal_56))
	{
		wait(0);
	}
	...
	if (unk_0xC13AFEAFC3F7AD96("digiscanner"))
	{
		uLocal_57 = unk_0x08732C0099FA1813("digiscanner");
	}
	uLocal_59 = unk_0xCA369FBC0DE29517();
	iLocal_58 = unk_0x1DD05E817C89C737();
}
