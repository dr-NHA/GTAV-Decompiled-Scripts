...
void __EntryFunction__()
{
	...
	iLocal_54 = unk_0xA0A2925EDC6DDA6D(joaat("weapon_sniperrifle"));
	iLocal_55 = unk_0xB39F6B1C186F538E(joaat("component_at_scope_large"));
	iLocal_56 = unk_0xB39F6B1C186F538E(joaat("component_at_ar_supp_02"));
	...
	while (true)
	{
		...
		if (func_174(&Var0, 0) && unk_0x1D5CD3EAAA7422B0((Var1.f_2 - Var3.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_265(&Var0, 1);
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_132(unk_0x4A8C381C258A124D()) && func_132(iParam0->f_28[0])) && !func_151()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam6) && func_193(unk_0x4A8C381C258A124D(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_211(unk_0x4A8C381C258A124D(), uParam0->f_35[iVar0]))
							{
...
int func_214(int iParam0, float fParam1)
{
	...
	{
		if (func_225(iParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), iParam0))
		{
...
{
	return func_216(iParam0, unk_0x4A8C381C258A124D(), fParam1, 1, 250, 7);
}
...
int func_220(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_222(unk_0xD1A6A821F5AC81DB(iParam1, 1) - unk_0xD1A6A821F5AC81DB(iParam0, 1)) };
	...
	{
		Var1 = { func_222(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_229(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_222(Param1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_241(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !unk_0xE100DD4F82A51BDE("rcmhunting2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				iLocal_58 = unk_0x8A3572575D91006C(joaat("weapon_sniperrifle"), 0, Local_57, 0, 1065353216, 0, 0, 1);
				unk_0x93A0B91D4456D7E9(iLocal_58, joaat("component_at_scope_large"));
				unk_0x93A0B91D4456D7E9(iLocal_58, joaat("component_at_ar_supp_02"));
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			if (unk_0xE10356B235A70E70(Local_57, 1f, iLocal_54, 0))
			{
				unk_0xCF39804E8C88080E(iLocal_58, 0f, -90f, -162.64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_249(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_248(&iVar0) || !func_250(&(uParam0->f_48))) || !unk_0xE100DD4F82A51BDE("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
