...
void func_1()
{
	switch (iLocal_82)
	{
		case 0:
			...
			func_21();
			if (!unk_0xD6F9DEE4765092A9(sLocal_189))
			{
				if (unk_0x1B79E937E91F40C3(sLocal_189, "PRE_FKICKOFF"))
				{
					while ((unk_0x1DD05E817C89C737() - iLocal_373) < 2000)
					{
						wait(0);
					}
				}
...
int func_95(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_38(unk_0x4A8C381C258A124D(), Local_200, 354.7487f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
int func_96(int iParam0, struct<3> Param1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			unk_0xF2CB0224D3BE0B42(sLocal_190, 0);
			unk_0xF2CB0224D3BE0B42(sLocal_202, 6);
	...
	switch (iLocal_82)
	{
		case 0:
			if (func_95(iLocal_81, bLocal_28))
			{
				...
				if (unk_0xC450B06E5AAA0985(uLocal_197))
				{
					unk_0x61183D6239A9D7B8(uLocal_197, 2);
					unk_0x032F99DF3B301AFA(uLocal_197, 2);
				}
		...
		case 1:
			func_106();
			if (func_105(unk_0x4A8C381C258A124D(), Local_200, 2f, 1) && func_104(28))
			{
				if (!iLocal_196)
				{
					unk_0x3C482AC51A8E85DC(unk_0x259BE71D8A81D4FA());
			...
			else
			{
				...
				else
				{
					...
					if (!func_105(unk_0x4A8C381C258A124D(), Local_200, 75f, 1))
					{
						if (!iLocal_195)
						{
							func_22(&uLocal_197);
					...
					else if (func_105(unk_0x4A8C381C258A124D(), Local_200, 12f, 1))
					{
						if (iLocal_195)
						{
							func_22(&uLocal_197);
...
int func_208(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_209(iParam0, uVar1[iVar3], 1) && func_97(unk_0xD1A6A821F5AC81DB(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_204(Param1, 0f, 0f, 0f, 0)) || unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(iParam0, 1), unk_0xD1A6A821F5AC81DB(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_240()
{
	if (!bLocal_28 && iLocal_81 != 3)
	{
		if (iLocal_81 > 0)
		{
			...
			if (!bLocal_193)
			{
				if (!func_105(unk_0x4A8C381C258A124D(), Local_200, 150f, 1))
				{
					func_247(2);
				}
				else if (!func_105(unk_0x4A8C381C258A124D(), Local_200, 75f, 1))
				{
					if (!bLocal_201)
					{
						unk_0x406CBCEA35499884();
...
void func_309(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_302(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x304A39EB177D246B(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_302(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x304A39EB177D246B(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x7B6C0A0D604E68FA(uVar1, 10, -1, 0, -1, func_310(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_376(bool bParam0)
{
	...
	if (unk_0x78411E34CF90EA8C(uLocal_198))
	{
		unk_0xE37AF9002E782BA0(0, 0, 3000, 1, 0, 0);
		unk_0x85E6A1E36B5E2E4D(uLocal_198, 0);
	}
}
