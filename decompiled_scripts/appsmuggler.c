...
void func_6()
{
	...
	{
		if (unk_0xA6F779AA284EB20E(uLocal_303))
		{
			iVar0 = unk_0x5DEF122A58D4F685(uLocal_303);
			switch (iVar0)
			{
				case 0:
					func_269();
				...
				case 29:
					...
					{
						iLocal_121 = 2;
						unk_0xDBCE37B37A697642(uLocal_302, "SHOW_SCREEN", 2f, -1082130432, -1082130432, -1082130432, -1082130432);
					}
					break;
...
{
	unk_0x88F483FBD433696A(uLocal_302, "SHOW_OVERLAY");
	func_200(sParam0);
...
void func_268()
{
	unk_0x88F483FBD433696A(uLocal_302, "HIDE_OVERLAY");
	unk_0xE6B753D52F4CA222();
	func_199(0);
...
void func_270()
{
	if (func_271())
	{
		if (!BitTest(uLocal_111, 0))
		{
			unk_0x88F483FBD433696A(uLocal_302, "GET_CURRENT_SELECTION");
			uLocal_303 = unk_0x6CA3F2B87712B6A4();
...
void func_274()
{
	if (func_214())
	{
		unk_0x88F483FBD433696A(uLocal_302, "UPDATE_SELL_COOLDOWN");
...
void func_277()
{
	...
	unk_0x88F483FBD433696A(uLocal_302, "UPDATE_STEAL_COOLDOWN");
	iVar0 = 1;
	while (iVar0 <= 8)
	{
...
void func_279()
{
	...
	unk_0x88F483FBD433696A(uLocal_302, "SET_STATS");
...
void func_313()
{
	...
	if (iVar1 != -1 && iVar1 < 31)
	{
		unk_0x88F483FBD433696A(uLocal_302, "REMOVE_ACTIVE_ORGANISATION");
		unk_0xA9A70CB35AC098D9(&(Local_301[iVar1 /*16*/]));
		unk_0xE6B753D52F4CA222();
...
void func_315(int iParam0, int iParam1)
{
	...
	if (func_15(iParam0))
	{
		...
		while (iVar2 < iVar3)
		{
			...
			if (iVar5 != func_16())
			{
				StringCopy(&(Var4[iVar2 /*16*/]), unk_0xBD6CA019F46AB947(iVar5), 64);
			}
			else
			{
		...
		while (iVar2 < iVar3)
		{
			if (unk_0xD6F9DEE4765092A9(&(Var4[iVar2 /*16*/])))
			{
				if (iVar2 != iVar3)
				{
					...
					while (iVar6 <= (iVar3 - 1))
					{
						if (!unk_0xD6F9DEE4765092A9(&(Var4[iVar6 /*16*/])))
						{
		...
		unk_0x88F483FBD433696A(uLocal_302, "ADD_ACTIVE_ORGANISATION");
...
void func_320()
{
	...
	{
		unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
		if (iLocal_121 == 1)
		{
			iLocal_121 = 0;
			unk_0xBF3D28CA44F3BE2D(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", 1);
	...
	{
		unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
		if (iLocal_121 == 0)
		{
			iLocal_121 = 1;
			unk_0xBF3D28CA44F3BE2D(-1, "Show_Source_Menu", "GTAO_SMG_Hangar_Computer_Sounds", 1);
	...
	if (unk_0xD67885288D4A40CB(2))
	{
		...
		{
			unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_323(2, 187, 1);
		if (unk_0x875A214D5EBCA509(2, 187))
		{
			unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0x2645430E708CBFAC(2, 187))
		{
			unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0x2645430E708CBFAC(2, 188))
		{
			unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (unk_0x875A214D5EBCA509(2, 188))
		{
			unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_323(2, 187, 1);
		if (unk_0x875A214D5EBCA509(2, 187))
		{
			unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	func_323(2, 189, 1);
	if (unk_0x875A214D5EBCA509(2, 189))
	{
		unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_323(2, 190, 1);
	if (unk_0x875A214D5EBCA509(2, 190))
	{
		unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_323(2, 201, 1);
	if (unk_0x875A214D5EBCA509(2, 201))
	{
		unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_323(2, 202, 1);
	...
	{
		unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_323(2, 204, 1);
	if (unk_0x875A214D5EBCA509(2, 204))
	{
		unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0xD67885288D4A40CB(2))
	{
		unk_0x88F483FBD433696A(uLocal_302, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			unk_0x88F483FBD433696A(uLocal_302, "SET_ANALOG_STICK_INPUT");
			iLocal_304 = iVar0;
			iLocal_305 = iVar1;
	...
	if (((iVar2 != 127 || iLocal_306 != 127) || iVar3 != 127) || iLocal_307 != 127)
	{
		...
		unk_0x330108B080A2132F(iLocal_307);
...
void func_321()
{
	...
	{
		iLocal_121 = 0;
		unk_0xDBCE37B37A697642(uLocal_302, "SHOW_SCREEN", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
		unk_0xBF3D28CA44F3BE2D(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", 1);
		return;
	}
	if (func_322())
	...
	{
		unk_0xDBCE37B37A697642(uLocal_302, "SET_INPUT_EVENT", to_float(202), -1082130432, -1082130432, -1082130432, -1082130432);
	}
...
void func_325()
{
	...
	unk_0xA4F67CEB594AE064(1);
	unk_0xA91A4C18A2DB01BD(uLocal_302, 255, 255, 255, 255, 0);
	func_336();
	func_329(0);
	func_326(1);
	...
	if (!BitTest(uLocal_111, 7) && !func_353())
	{
		...
		while (iVar1 < iVar2)
		{
			...
			if (func_352(iVar3))
			{
				...
				unk_0x0B0C9A0F9AAEB7F0(&Global_1949959, iVar1);
				func_343(iVar3);
			}
			else
			{
...
{
	func_380();
	uLocal_302 = unk_0x8DE4F68A9728925E("HANGAR_CARGO");
	while (!unk_0xA0C7B98BCF1EEF9E(uLocal_302))
	{
		wait(0);
	}
	func_330(1);
...
{
	unk_0xD314260005F064BF(&uLocal_302);
	func_388(iParam0);
	func_390(0);
	func_393();
