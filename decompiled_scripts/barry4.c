...
void func_1()
{
	switch (iLocal_80)
	{
		...
		case 1:
			...
			func_224(&uLocal_83, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
...
int func_337(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_339(iParam0, uVar1[iVar3], 1) && func_338(unk_0xD1A6A821F5AC81DB(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_333(Param1, 0f, 0f, 0f, 0)) || unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(iParam0, 1), unk_0xD1A6A821F5AC81DB(uVar1[iVar3], 1), 1) < 10f)
					{
...
int func_388(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_394())
	{
		...
		{
			iVar2 = func_389(unk_0x1AF90EB93E0012D6());
			if (iVar2 > -1)
			{
