...
int func_2()
{
	...
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_235))
		{
			if (unk_0x13CCB1AD131C1082(Global_100402, &sLocal_239, &cLocal_271, 3))
			{
				...
				fVar0 = unk_0xBD3B265153D3BA2D(iLocal_280);
				if (!iLocal_234)
				{
				...
				if (fVar0 < 0.2812f)
				{
					if (iLocal_281 != 0)
					{
						unk_0x182120534CCF9023(iLocal_281, 0);
						iLocal_281 = 0;
					}
				}
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_281 == 0)
					{
						iLocal_281 = unk_0x62750FD2BDD8BD49("scr_lamgraff_paint_spray", uLocal_235, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
						unk_0x6154AB43546C6437(iLocal_281, fLocal_282, fLocal_283, fLocal_284, 0);
					}
				}
...
int func_26()
{
	...
	if (!unk_0x4FAFF4BCB7633475(Global_100402))
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_235))
		{
			if (unk_0x13CCB1AD131C1082(Global_100402, &sLocal_239, &cLocal_255, 3))
			{
				if (unk_0x5B702A5D1F2635BE(Global_100402))
				{
					unk_0xE1C7B23ECC5080B5(Global_100402, 0, 0);
				...
				{
					unk_0x974022927CB47E68(Global_100402);
					if (!unk_0x5266F1D2AEF6F73A(iLocal_280))
					{
						iLocal_280 = unk_0x2EC137C692A52458(Local_237, 0f, 0f, uLocal_238, 2);
						unk_0xBF3497E24DEAD835(iLocal_280, 1);
					}
					unk_0x3DA436E63AB0F541(Global_100402, iLocal_280, &sLocal_239, &cLocal_271, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
...
void func_37()
{
	unk_0xEC9DAA34BBB4658C(iLocal_236);
	unk_0x8003D3C0115A1035();
	while (!unk_0xFC8BFE4B41177C22(Global_100402) || !unk_0x6252BC0DD8A320DB(iLocal_236))
	{
		wait(0);
	}
	...
	func_38(&uLocal_68, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
	uLocal_235 = unk_0x4E55EAB577C13329(iLocal_236, unk_0xD1A6A821F5AC81DB(Global_100402, 1), 1, 1, 0);
	unk_0x4D306DD94DD6FDBA(uLocal_235, Global_100402, unk_0x72F7E39FB49FC0BA(Global_100402, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
