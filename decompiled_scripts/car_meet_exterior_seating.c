...
int func_64()
{
	...
	if (unk_0xED977E2AE2CB16EE(func_73(unk_0x259BE71D8A81D4FA()), Global_1950108.f_1029[154 /*3*/], 1) >= 150f)
	{
		return 1;
	}
	if (func_65())
...
int func_74(int iParam0)
{
	if (iParam0 != func_52())
	{
		...
		else if ((Global_1575060 && iParam0 == unk_0x259BE71D8A81D4FA()) && func_53(iParam0, 1, 0))
		{
			return Global_2657589[iParam0 /*466*/].f_321.f_7 != -1;
		}
	}
