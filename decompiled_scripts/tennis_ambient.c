...
void __EntryFunction__()
{
	...
	if (((func_338(10) && unk_0x486FF5D06E9659F1(joaat("tennis")) == 0) || Global_97609) && !ScriptParam_618.f_1)
	{
	...
	while (true)
	{
		...
		if (unk_0xBF52D447C795492B() && !ScriptParam_618.f_1)
		{
			func_306(&Var0);
		}
		if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
		{
			if (vdist2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Var0.f_189.f_55) < 5625f || ScriptParam_618.f_1)
			{
		...
		if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
		{
			if (vdist2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Var0.f_189.f_55) > (fVar2 * fVar2))
			{
				func_306(&Var0);
			}
		}
		if ((func_338(10) && unk_0x486FF5D06E9659F1(joaat("tennis")) == 0) && !ScriptParam_618.f_1)
		{
			func_306(&Var0);
		}
		wait(0);
...
void func_2(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	switch (func_305(uParam1))
	{
		...
		case 4:
			if (func_268(uParam0))
			{
				if (uParam0->f_1657 == 1)
				{
					...
					func_266(uParam0[iParam3 /*94*/], unk_0xB1DBFEB95C0EFB88(1, uParam0->f_1669, Var13, unk_0x97BC40FFA2FFCCD2(uParam0->f_1658, uParam0->f_1658.f_1), 0, 0));
					...
					func_266(uParam0[iParam4 /*94*/], unk_0xB1DBFEB95C0EFB88(1, uParam0->f_1668, Var1, unk_0x97BC40FFA2FFCCD2(-uParam0->f_1658, -uParam0->f_1658.f_1), 0, 0));
		...
		case 8:
			...
			bVar14 = (unk_0x1DD05E817C89C737() > func_254(uParam0[iParam3 /*94*/]) && unk_0x1DD05E817C89C737() > func_254(uParam0[iParam4 /*94*/]));
		...
		case 9:
			...
			else
			{
				...
				if (unk_0x13CCB1AD131C1082(func_265(uParam0[func_271(uParam1) /*94*/]), sVar18, "serve", 3))
				{
					if (uParam0->f_1657 == 1 && unk_0xFC8BFE4B41177C22(uParam0->f_247))
					{
						fVar19 = unk_0x82E64DE58A6B84A8(func_265(uParam0[func_271(uParam1) /*94*/]), sVar18, "serve");
...
Vector3 func_123(var uParam0, var uParam1, struct<3> Param2, int iParam3)
{
	...
	{
		fVar6 = func_124(0.4f, 1f, unk_0xD2AA6F822D3A55D2(0, 1065353216));
...
int func_133(var uParam0, var uParam1, struct<3> Param2, bool bParam3)
{
	...
	Var8 = { unk_0x83FDC027F0BEA202(func_265(uParam0), 60309, 0f, 0f, 0f) };
	Var9 = { Var0 - Var8 };
...
int func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, float fParam7, float fParam8, var uParam9)
{
	...
	*fParam8 = unk_0xA2DD309FA5FD1435(Var5, func_116(bParam6, *uParam5, *uParam4), func_116(bParam6, *uParam4, *uParam5), 0);
	...
	while (uParam1->f_247.f_33 <= 0f)
	{
		...
		*uParam2 = { uParam1->f_1583[iVar0 /*3*/] };
		...
		if (iVar1 == 1)
		{
			...
			{
				func_164(uParam0);
				func_172(uParam0, (to_float(iVar0) * unk_0x0B852B0BF94A8DC1()));
			}
		}
		if (!func_171(*uParam2))
		{
...
int func_181(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (func_104(uParam2, 4))
	{
		...
		else if (uParam2->f_4.f_20 == 0)
		{
			...
			iVar0 = func_50(unk_0xD2AA6F822D3A55D2(0, 1065353216) < 0.2f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 1)
		{
			iVar7 = unk_0xC5935DFB3F39785A(1, 4);
			iVar0 = func_50(unk_0xD2AA6F822D3A55D2(0, 1065353216) < 0.1f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 2)
		{
			iVar0 = unk_0xC5935DFB3F39785A(0, 2);
		}
		Var5 = { func_122(Var6, Var5, unk_0xD2AA6F822D3A55D2(0, 1065353216)) };
...
void func_218(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (!unk_0x4FAFF4BCB7633475(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			...
			fVar2 = (unk_0x97BC40FFA2FFCCD2(uParam0->f_40, uParam0->f_40.f_1) + func_327(bParam6, 180f, 0f));
			...
			if (!bParam6 && bParam7)
			{
				...
				unk_0x10425721983AE158(0, func_194(func_195(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar6, 0, 0, 0, 0, 0);
			}
			if (!bParam8)
			{
...
void func_227(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if (!unk_0x4FAFF4BCB7633475(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			unk_0x5C96CEA06531AB03(uParam0->f_32, unk_0xCFC0C995455A6204(uParam0->f_32));
			func_58(uParam0, 16384);
			fVar2 = (unk_0x97BC40FFA2FFCCD2(uParam0->f_40, uParam0->f_40.f_1) + func_327(bParam8, 180f, 0f));
			Var3 = { uParam1->f_189.f_29 - unk_0xD1A6A821F5AC81DB((uParam1[iParam3 /*94*/])->f_32, 1) };
			bVar4 = func_69(Var3, uParam0->f_40) < 0f;
			bVar5 = func_69(Var3, uParam0->f_43) < 0f;
			func_222(uParam0, 0);
...
void func_236(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (((func_75(uParam0) == 75 && unk_0xFC8BFE4B41177C22(uParam1->f_247)) && unk_0x14E25ED5E75102C8(uParam1->f_247)) && vdist2(uParam0->f_37, func_283(&(uParam1->f_247))) < (0.88f * 0.88f))
	{
		func_58(uParam0, 256);
	...
	switch (func_146(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_75(uParam0) == 75)
			{
				...
				{
					unk_0x63C8DCBEC1CF8225(func_265(uParam0), Var1, 2f, -1, 1193033728, 1056964608);
				...
				else if ((unk_0x65FFA94B82A71741(uParam0->f_32, func_70(&(uParam0->f_4)), Var2, 0, 1, 0) || unk_0x9B5C1660CCDF7189(func_265(uParam0), joaat("script_task_go_straight_to_coord")) == 7) && !func_228(&(uParam0->f_4), 256))
				{
					func_235(&(uParam0->f_4), 0);
					func_217(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_75(uParam0) == 75)
			{
				unk_0x148F60DDDBC323FD(func_283(uParam4), func_283(uParam4) + uParam4->f_10, uParam0->f_37, uParam0->f_40, &fVar3);
				...
				if (((!unk_0x4FAFF4BCB7633475(func_265(uParam0)) && !vdist2(uParam0->f_37, Var1) <= (0f * 0f)) && !func_228(&(uParam0->f_4), 4)) && !func_104(uParam0, 1024))
				{
				...
				else if (vdist2(uParam0->f_37, Var1) <= (0f * 0f) || unk_0x9B5C1660CCDF7189(func_265(uParam0), joaat("script_task_go_straight_to_coord")) == 7)
				{
...
void func_262(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!unk_0x4FAFF4BCB7633475(func_265(uParam0[iParam1 /*94*/])) && !unk_0x4FAFF4BCB7633475(func_265(uParam0[iParam2 /*94*/])))
	{
		...
		else
		{
			if (!bParam4)
			{
				unk_0x4D306DD94DD6FDBA((uParam0[iParam1 /*94*/])->f_33, func_265(uParam0[iParam1 /*94*/]), unk_0x72F7E39FB49FC0BA(func_265(uParam0[iParam1 /*94*/]), 28422), Local_164, Local_165, 0, 0, 0, 0, 2, 1, 0);
			}
			unk_0x4D306DD94DD6FDBA((uParam0[iParam2 /*94*/])->f_33, func_265(uParam0[iParam2 /*94*/]), unk_0x72F7E39FB49FC0BA(func_265(uParam0[iParam2 /*94*/]), 28422), Local_164, Local_165, 0, 0, 0, 0, 2, 1, 0);
		}
	}
}
...
int func_279(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, float fParam11, bool bParam12)
{
	...
	Var0 = { 0f, 0f, 1f };
	fVar1 = func_327(fParam9 == -1f, unk_0x0B852B0BF94A8DC1(), fParam9);
	iVar2 = 0;
