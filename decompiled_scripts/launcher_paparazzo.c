...
var func_175(struct<3> Param0, int iParam1)
{
	var uVar0;
...
int func_202(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_132(unk_0x4A8C381C258A124D()) && func_132(iParam0->f_28[0])) && !func_151()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam6) && func_197(unk_0x4A8C381C258A124D(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_226(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_246(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_255(&iVar0) || !unk_0xE100DD4F82A51BDE(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_258(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_255(&iVar0) || !unk_0xE100DD4F82A51BDE(sVar4))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 3:
			if (func_132(uParam0->f_41[0]))
			{
				uLocal_54 = unk_0x2EC137C692A52458(unk_0xD1A6A821F5AC81DB(uParam0->f_41[0], 1), unk_0x88124E0D60FB8D11(uParam0->f_41[0], 2), 2);
				unk_0x381D671BCFC294D9(uParam0->f_41[0], uLocal_54, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				unk_0xBF3497E24DEAD835(uLocal_54, 1);
				if (func_132(uParam0->f_28[0]))
				{
					unk_0x3DA436E63AB0F541(uParam0->f_28[0], uLocal_54, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_132(uParam0->f_41[1]))
				{
					unk_0x381D671BCFC294D9(uParam0->f_41[1], uLocal_54, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_132(uParam0->f_41[2]))
				{
					unk_0x381D671BCFC294D9(uParam0->f_41[2], uLocal_54, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_132(uParam0->f_28[0]) && func_132(unk_0x4A8C381C258A124D()))
			{
				...
				uLocal_54 = unk_0x2EC137C692A52458(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
				unk_0xBF3497E24DEAD835(uLocal_54, 1);
				unk_0x3DA436E63AB0F541(uParam0->f_28[0], uLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
