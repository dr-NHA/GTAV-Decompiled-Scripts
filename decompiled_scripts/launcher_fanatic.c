...
void func_192(int iParam0)
{
	...
	if ((unk_0x1DD05E817C89C737() - iLocal_57) >= 900)
	{
		if (func_203(iParam0->f_28[0]))
		{
			if (!func_150())
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_203(unk_0x4A8C381C258A124D()) && func_203(iParam0->f_28[0])) && !func_150()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam6) && func_199(unk_0x4A8C381C258A124D(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_183(2))
	{
		if (!func_150())
		{
			if (((func_203(unk_0x4A8C381C258A124D()) && func_203(iParam0->f_28[0])) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam6) && func_199(unk_0x4A8C381C258A124D(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_198(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_196(&uVar0, cParam2, sParam3, 7, 0, 0);
...
int func_230(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_232(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
