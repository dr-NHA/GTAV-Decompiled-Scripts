...
void func_1()
{
	switch (iLocal_71)
	{
		...
		case 3:
			if (!func_76(iLocal_71))
			{
				if (((func_73() && !func_72()) && func_71()) && !func_70(0))
				{
					if (iLocal_73 != 0)
					{
						if (unk_0x8018AA59F97FA9E3(iLocal_73))
						{
		...
		case 4:
			...
			{
				unk_0x04FC75A7251431C6(uLocal_66, 0.75f);
			}
			if (!func_76(4))
			{
		...
		case 6:
			...
			if (!func_34(2))
			{
				...
				{
					unk_0xE226F16D30AF5945(Local_58, 200f, joaat("prop_mineshaft_door"), 0);
					func_33(2, 1);
				}
			}
			if (func_73() && !func_72())
...
void func_33(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		unk_0x0B0C9A0F9AAEB7F0(&uLocal_78, iParam0);
	}
	else
	{
		unk_0x8744D2E3FC95740E(&uLocal_78, iParam0);
	}
}
...
void func_35()
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			{
				if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), Local_51, Local_57, 1, 1, 0))
				{
					if (func_62())
					{
						iLocal_60 = 2;
		...
		case 1:
			...
			{
				if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), Local_52, Local_57, 1, 1, 0))
				{
					func_54(0);
					iLocal_60 = 3;
					func_61(0, 800);
		...
		case 2:
			...
			{
				func_45(24, 0);
				func_44(unk_0x4A8C381C258A124D(), Local_55, fLocal_56);
				...
				unk_0x4A3280817398D754(Local_55, 20f, 0);
				func_39(24, &iLocal_59);
				unk_0x74C1590CC91B3930(iLocal_59);
				iLocal_72 = (unk_0x1DD05E817C89C737() + 40000);
				while ((!unk_0x9E2D35FA908F57B4() || !unk_0xD0B0D1BD29678350(iLocal_59)) && iLocal_72 > unk_0x1DD05E817C89C737())
				{
					wait(0);
				}
				unk_0x6981C3213B841071();
				if (iLocal_72 <= unk_0x1DD05E817C89C737())
				{
					unk_0xBBB6D0F765409642(iLocal_59);
					func_44(unk_0x4A8C381C258A124D(), Local_53, fLocal_54);
					func_61(1, 800);
					iLocal_60 = 0;
				}
				else
	...
	switch (iLocal_61)
	{
		...
		case 2:
			...
			if (unk_0x875A214D5EBCA509(2, 51))
			{
				...
				{
					iLocal_72 = unk_0x1DD05E817C89C737() + 300;
...
int func_63()
{
	...
	if (unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 && iLocal_60 == 0)
	{
		return 0;
	}
	if (func_70(0))
...
void func_68(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		...
		if (!bParam2)
		{
			unk_0xBF3D28CA44F3BE2D(uLocal_69, sLocal_67, sLocal_68, 0);
		}
		func_69();
	}
	else
...
void func_82()
{
	if (func_67(unk_0x4A8C381C258A124D()))
	{
		Local_70 = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0) };
	}
}
...
void func_84()
{
	switch (iLocal_71)
	{
		...
		case 4:
			...
			func_85(sLocal_74);
			uLocal_66 = unk_0xB1DBFEB95C0EFB88(26, joaat("u_f_m_drowned_01"), func_75(4), 184.5548f, 1, 1);
			unk_0x55098D9E9AD58806(joaat("u_f_m_drowned_01"));
			unk_0x10425721983AE158(uLocal_66, sLocal_74, sLocal_75, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
			unk_0xAAA71DD7E9059338(uLocal_66, 1);
			unk_0x44FB298D6382876D(uLocal_66, 1);
			unk_0x5D7CD709B34C90F0(uLocal_66, 1);
			unk_0xFD61BB3B8F1CDB6D(uLocal_66, 1);
			unk_0xEA65800FC08BB2CB(uLocal_66, 1);
			unk_0x0428AFDCAA63B06E(uLocal_66, 118, 0);
			unk_0x0428AFDCAA63B06E(uLocal_66, 208, 1);
			unk_0x935364B4448CD584(uLocal_66, 1);
			unk_0x3CEA1FD137ACE2D9(uLocal_66, joaat("player"));
			break;
		
		case 5:
			iLocal_63 = 731806707;
			unk_0xB80B2E08713B8BC6(iLocal_63, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, 1, 0);
			unk_0xEBB2809684978887(iLocal_63, 1, 1, 0);
			uLocal_62 = unk_0x96A32328480B485C(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
			break;
		
		case 6:
			func_86(joaat("u_m_o_filmnoir"));
			uLocal_64 = unk_0xB1DBFEB95C0EFB88(26, joaat("u_m_o_filmnoir"), func_75(6), 22.9631f, 1, 1);
			unk_0x7F08C4791E6D6969(uLocal_64, 0, 0, 0, 0, 1);
			unk_0x55098D9E9AD58806(joaat("u_m_o_filmnoir"));
			unk_0xFD61BB3B8F1CDB6D(uLocal_64, 1);
			unk_0xEA65800FC08BB2CB(uLocal_64, 1);
			unk_0xB958FAC3AA36D900(uLocal_64, joaat("weapon_sniperrifle"));
			unk_0x3CEA1FD137ACE2D9(uLocal_64, joaat("player"));
			uLocal_65 = unk_0x43AFC452F25F3A2F(joaat("prop_vintage_filmcan"), -543.71f, 1986.2f, 126.05f, 1, 1, 0);
			break;
	}
}
...
void func_91()
{
	switch (iLocal_71)
	{
		...
		case 2:
		case 3:
			unk_0x4FD2A45FD634CE58(iLocal_73);
			iLocal_73 = 0;
			break;
		...
		case 5:
			if (unk_0x116053132936EA1F(iLocal_63))
			{
				unk_0x19B3B7AC049E8354(iLocal_63, 0);
			}
			if (unk_0x78411E34CF90EA8C(uLocal_62))
			{
		...
		case 6:
			...
			{
				unk_0xB3B56385ECA230B4(&iLocal_65);
			}
			if (func_34(2))
			{
				unk_0xC94AE68759E1B3BD(Local_58, 200f, joaat("prop_mineshaft_door"), 0);
			}
			break;
	}
}
