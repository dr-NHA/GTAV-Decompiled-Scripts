...
void __EntryFunction__()
{
	...
	func_236(&Var0);
	uLocal_52 = unk_0xA7B0B03284E7503C(Var1 - Vector(20f, 20f, 20f), Var1 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
...
int func_216(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_218(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
