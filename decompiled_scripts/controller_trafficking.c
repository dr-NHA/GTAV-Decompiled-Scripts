...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_178())
		{
			...
			{
				fLocal_31 = vdist2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Local_32);
			}
			func_176(&iVar1);
			func_31(&iVar2);
			if (iLocal_39 > 3)
			{
				if (fLocal_31 < 600f)
				{
					if (func_28(0) == 0 && (unk_0x1DD05E817C89C737() - iLocal_59) > 2000)
					{
...
void func_31(int iParam0)
{
	...
	switch (iLocal_43)
	{
		...
		case 3:
			...
			{
				unk_0x60040CDD28AA1BC3(Local_45, 4f, 0, 0, 0, 0, 0, 0, 0);
				if (unk_0xFC8BFE4B41177C22(iLocal_44))
				{
					unk_0x8C1F7D7A31B2A38E(&iLocal_44);
				}
				iLocal_44 = unk_0x5779387E956077A6(func_167(), Local_45, fLocal_46, 1, 1, 0);
				unk_0x4DC72C4B884A6C59(iLocal_44, 0);
				unk_0x55098D9E9AD58806(func_167());
				if (unk_0xFC8BFE4B41177C22(iLocal_44))
				{
					if (unk_0x579FA5568DE0C2A0(iLocal_44, 1))
					{
						unk_0xD772F6AA66750D2B(iLocal_44, 1, 1);
					}
					if (unk_0x579FA5568DE0C2A0(iLocal_44, 2))
					{
						unk_0xD772F6AA66750D2B(iLocal_44, 2, 0);
					}
					if (unk_0x579FA5568DE0C2A0(iLocal_44, 3))
					{
						unk_0xD772F6AA66750D2B(iLocal_44, 3, 0);
					}
					unk_0xD133EF7430EDCD09(iLocal_44, 0, 0);
				}
				iLocal_43 = 4;
			}
			break;
		...
		case 4:
			...
			if (!bVar0 && !*iParam0)
			{
				...
				if (!iLocal_47)
				{
					if (unk_0x7F420695E3F776FB(iLocal_28, 0))
					{
						...
						{
							iLocal_47 = 1;
							unk_0x68298CA6191CDFDB(&iLocal_44);
							iLocal_43 = 9;
						}
					}
				}
			...
			if (*iParam0)
			{
				if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0) && !unk_0x1C2F771CDC87A3A5(iLocal_44, 0))
				{
					unk_0x73CAFD2038E812B3(unk_0x4A8C381C258A124D(), iLocal_44, -1);
				}
			}
			if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0) && !unk_0x1C2F771CDC87A3A5(iLocal_44, 0))
			{
				if (unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), iLocal_44, 1))
				{
					func_165();
				}
			}
			if (!unk_0x1C2F771CDC87A3A5(iLocal_44, 0) && !unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
			{
				if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
				{
					...
					if (iVar2 == iLocal_44)
					{
						if (vdist2(Local_45, unk_0xD1A6A821F5AC81DB(iLocal_28, 1)) < 100f)
						{
		...
		case 6:
			if (unk_0xA6E4F7A73ABC4A76("Traffick_Ground"))
			{
				...
				if (iVar3 == 1)
				{
					...
					unk_0xEE0BCDB1B5E36BCB(iLocal_44, 1, 0);
					unk_0x68298CA6191CDFDB(&iLocal_44);
...
Vector3 func_123(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
void func_166()
{
	...
	if (!unk_0xFC8BFE4B41177C22(iLocal_29))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
		{
			if (vdist2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Local_32) < 2500f)
			{
	...
	switch (iLocal_39)
	{
		...
		case 3:
			...
			if (unk_0x6252BC0DD8A320DB(joaat("cuban800")))
			{
				...
				{
					unk_0x60040CDD28AA1BC3(Local_42, 8f, 0, 0, 0, 0, 0, 0, 0);
					iLocal_40 = unk_0x5779387E956077A6(joaat("cuban800"), Local_42, 25.29f, 1, 1, 0);
					unk_0x55098D9E9AD58806(joaat("cuban800"));
					unk_0x20DD46D27530FAC7(iLocal_40, 2);
		...
		case 4:
			if (unk_0xFC8BFE4B41177C22(iLocal_40))
			{
				if (unk_0x1C2F771CDC87A3A5(iLocal_40, 0) || unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
				{
					iLocal_39 = 9;
					return;
				}
			...
			if (func_28(9))
			{
				if (unk_0x486FF5D06E9659F1(joaat("traffick_ground")) == 1)
				{
					if (!unk_0x1C2F771CDC87A3A5(iLocal_40, 0))
					{
						unk_0x0B74F181ADFC39BF(iLocal_40, 2);
						return;
					}
				}
			}
			else if (unk_0x486FF5D06E9659F1(joaat("traffick_ground")) == 0)
			{
				if (!unk_0x1C2F771CDC87A3A5(iLocal_40, 0))
				{
					unk_0x0B74F181ADFC39BF(iLocal_40, 1);
				}
			}
			if (!bLocal_35)
			{
			...
			if (!bVar0 && !*iParam0)
			{
				if (!iLocal_41)
				{
					if (unk_0x7F420695E3F776FB(iLocal_28, 0))
					{
						...
						{
							iLocal_41 = 1;
							unk_0x68298CA6191CDFDB(&iLocal_40);
							iLocal_39 = 9;
						}
					}
				}
			...
			if (*iParam0)
			{
				unk_0x73CAFD2038E812B3(iLocal_28, iLocal_40, -1);
			}
			if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0) && !unk_0x1C2F771CDC87A3A5(iLocal_40, 0))
			{
				if (unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), iLocal_40, 1))
				{
					func_165();
				}
			}
...
void func_177(bool bParam0)
{
	...
	if (unk_0xFC8BFE4B41177C22(iLocal_40))
	{
		if (bParam0)
		{
			unk_0x8C1F7D7A31B2A38E(&iLocal_40);
		}
		else
		{
			unk_0x68298CA6191CDFDB(&iLocal_40);
...
void func_192()
{
	if (!iLocal_58)
	{
		iLocal_57 = unk_0xA7B0B03284E7503C(Vector(40.073f, 4788.559f, 2157.109f) - Vector(25f, 25f, 25f), Vector(40.073f, 4788.559f, 2157.109f) + Vector(25f, 25f, 25f), 0, 1, 1, 1);
		iLocal_58 = 1;
	}
}
...
void func_194()
{
	if (iLocal_57 != 0)
	{
		unk_0xD7B6A43ACC36D868(iLocal_57, 0);
	}
	func_177(1);
	func_168(1);
	func_197();
...
void func_197()
{
	...
	while (iVar0 < 5)
	{
		if (unk_0xB0E14182FAD64944(uLocal_50[iVar0]))
		{
			unk_0xDDFB0941A19702BE(uLocal_50[iVar0]);
		}
		if (unk_0xFC8BFE4B41177C22(uLocal_49[iVar0]))
		{
			unk_0x51C8BEA2005931AB(&(uLocal_49[iVar0]));
		}
		iVar0++;
	}
}
