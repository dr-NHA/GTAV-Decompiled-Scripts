...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		Var1 = { unk_0xD1A6A821F5AC81DB(uLocal_68, 0) };
		fVar2 = vdist2(Local_170 + Local_173, Var1);
		if (fVar2 < (4.5f * 4.5f))
		{
			unk_0x7C8E9DE09D4AD3FF(uLocal_68, uLocal_70, uLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
int func_3(var uParam0)
{
	...
	if (unk_0xD9F5E1FEFD1329E4(uLocal_70, 0))
	{
	}
	else
	{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (unk_0x5266F1D2AEF6F73A(Global_98011))
		{
			...
			if (!func_5(Global_100402, uLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					unk_0x73CAFD2038E812B3(Global_100402, uLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
				unk_0x5D7CD709B34C90F0(uLocal_68, 0);
				iLocal_172 = 1;
			}
			unk_0xFCCE667AD0E974AD(uLocal_68, uLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_100402, uLocal_70, 2))
			...
			unk_0xC0086E5CBF13BBF7(uLocal_70, -8f, 1);
			wait(100);
			if (!func_3(&uVar0))
			{
				unk_0xB5396F1FB088FE38(&uVar2);
				unk_0xFCCE667AD0E974AD(0, uLocal_70, 24, 50);
				unk_0x5524CAF18378DF39(0, 2000);
				unk_0xCF6CC9EA0D2EFE23(0, uLocal_70, Local_170 + Local_173, uLocal_171, 0, uLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				unk_0x93C0674FC00824D0(uVar2);
				unk_0x4BD42B0527065BB6(iLocal_68, uVar2);
...
void func_22()
{
	...
	uLocal_70 = unk_0x66D94742BB3D032F(Local_173 + Local_169, 15f, uLocal_71, 2);
	iVar0 = 0;
	while ((!unk_0xFC8BFE4B41177C22(Global_100402) || !unk_0xFC8BFE4B41177C22(uLocal_70)) || (!unk_0x6252BC0DD8A320DB(iLocal_69) && iVar0 < 400))
	{
		if (!unk_0xFC8BFE4B41177C22(iLocal_70))
		{
			iLocal_70 = unk_0x66D94742BB3D032F(Local_173 + Local_169, 15f, uLocal_71, 2);
		}
		iVar0++;
		wait(0);
	}
	...
	{
		unk_0xC229299217554C78(iLocal_70, 1, 1, 0);
		unk_0x0B74F181ADFC39BF(iLocal_70, 2);
		unk_0x1DE99C193C7EC64B(iLocal_70, 1084227584);
		iLocal_68 = unk_0x8728A378EF2B46B2(iLocal_70, 4, iLocal_69, -1, 1, 1);
		unk_0xC6E8E1D693021E9E(iLocal_68, 0);
...
void func_52()
{
	if (!unk_0x1C2F771CDC87A3A5(iLocal_68, 0) && unk_0x7C9905528EE2C3AB(iLocal_68, 1))
	{
		unk_0xF09E30AF1B8FB379(&iLocal_68);
	}
	if (!unk_0x1C2F771CDC87A3A5(iLocal_70, 0) && unk_0x7C9905528EE2C3AB(iLocal_70, 1))
	{
		unk_0x68298CA6191CDFDB(&iLocal_70);
	}
