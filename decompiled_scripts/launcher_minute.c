...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_212(329.513f, 3402.691f, 36.258f, unk_0xD1A6A821F5AC81DB(Var0.f_35[1], 1), 1056964608))
				{
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_132(unk_0x4A8C381C258A124D()) && func_132(iParam0->f_28[0])) && !func_151()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam6) && func_196(unk_0x4A8C381C258A124D(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_183(2))
		{
			if (!func_151())
			{
				if (((func_132(unk_0x4A8C381C258A124D()) && func_132(iParam0->f_28[0])) && func_132(iParam0->f_28[1])) && func_196(unk_0x4A8C381C258A124D(), Param1, 1) < 20f)
				{
			...
			else if (((func_199(sParam3) && !*uParam8 == 1) && func_132(unk_0x4A8C381C258A124D())) && func_196(unk_0x4A8C381C258A124D(), Param1, 1) >= 20f)
			{
				func_295("pause conversation");
				func_198(1);
				*uParam8 = 1;
			}
			if (func_196(unk_0x4A8C381C258A124D(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_201(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(sParam1))
		{
			...
			{
				if (func_196(unk_0x4A8C381C258A124D(), Param2, 1) <= 100f)
				{
					func_204(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_196(unk_0x4A8C381C258A124D(), Param2, 1) > 120f)
				{
					func_206(iParam0);
				}
			}
...
var func_250()
{
	return unk_0xA7B0B03284E7503C(-309.1f, 6205.4f, 30f, -279.33f, 6217.98f, 40f, 0, 1, 1, 1);
}
...
int func_263(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			unk_0x2094BC4B6731BA68(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			if (!func_260(&iVar0) || !unk_0xE100DD4F82A51BDE("rcmminute1"))
			{
				return 0;
			}
			iLocal_51 = 2;
