							...
							if (func_229(iVar6))
							{
								if (Global_1653913.f_1353[iVar6 /*11*/][iVar0] == iVar1 + 3 || Global_1653913.f_1187[iVar6 /*11*/][iVar0] == 1)
								{
									if (func_225(Global_1653913.f_1187[iVar6 /*11*/][iVar0]))
									{
										...
										{
											unk_0x9A122D542F2BB60E(82, iVar5);
		...
		if (unk_0x38D063D8CF6D1967("TimerBars"))
		{
			...
			if (bParam18)
			{
				...
				if (unk_0x38D063D8CF6D1967("CommonMenu"))
				{
					...
					if (bParam11 == 1)
					{
						...
						fVar12 = unk_0x43026780D77E3DC0(1);
					}
					else
					{
			...
			if (bVar4)
			{
				if (iParam21 != 0)
				{
					...
					switch (iParam21)
					{
						...
						case 18:
							if (iParam28 != func_68())
							{
								...
								if (iVar17 != 0)
								{
									sVar21 = unk_0x008C0EB38E4459EE(iVar17);
									sVar22 = unk_0x008C0EB38E4459EE(iVar17);
								}
							}
							if (func_123())
							{
					...
					if (!unk_0xD6F9DEE4765092A9(sVar21))
					{
						unk_0xD0D00ED689D6CA81(sVar21, 0);
						if (unk_0x38D063D8CF6D1967(sVar21))
						{
					...
					if (iParam21 == 18)
					{
						if (!unk_0xD6F9DEE4765092A9(sVar18))
						{
							unk_0xD0D00ED689D6CA81(sVar18, 0);
							if (unk_0x38D063D8CF6D1967(sVar18))
							{
...
void func_83(var uParam0, int iParam1)
{
	...
	unk_0xA306E6FD2A6558E6(iParam1, &uVar1, &uVar2, &uVar3, &uVar4);
	Var0.f_4 = uVar1;
	Var0.f_5 = uVar2;
	Var0.f_6 = uVar3;
	Var0.f_7 = uVar4;
...
void func_132(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, var uParam23, bool bParam24, int iParam25, int iParam26, int iParam27, int iParam28, int iParam29, int iParam30, bool bParam31, int iParam32, int iParam33, var uParam34, int iParam35, int iParam36)
{
	...
	if (func_125())
	{
		...
		unk_0xD0D00ED689D6CA81("TimerBars", 0);
		if (func_138(&cVar21, &Var22, &cVar24, &Var25, &cVar27, &Var28, &cVar30, &Var31, &cVar33, &Var34) && unk_0x38D063D8CF6D1967("TimerBars"))
		{
			iVar66 = func_101();
			unk_0xA4F67CEB594AE064(iVar66);
			Var0.f_0 = *uParam3;
			Var0.f_1 = uParam3->f_1;
			if (iParam5 < 1000000)
			{
