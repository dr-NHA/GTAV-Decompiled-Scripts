...
void func_24(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 4:
			...
			Var2 = { unk_0xBE8776D2466E9EA6(&sVar0, &sVar1, func_53(uParam0), func_52(uParam0), 0, 2) };
			Var3 = { unk_0x7A6103DCF5EE8CC3(&sVar0, &sVar1, func_53(uParam0), func_52(uParam0), 0, 2) };
			uVar4 = Var3.f_2;
			fVar5 = 0.05f;
		...
		case 5:
			...
			Var7 = { unk_0x7A6103DCF5EE8CC3(&sVar0, &sVar1, func_53(uParam0), func_52(uParam0), 0, 2) };
			fVar8 = Var7.f_2;
			if ((iVar6 != 1 && iVar6 != 0) || func_39(unk_0xCFC0C995455A6204(unk_0x4A8C381C258A124D()), fVar8, 5f))
			{
				if (uParam0->f_1.f_1 == 4)
				{
					if (unk_0xBCF87EE3DC296C2A(0) == 4)
...
int func_69(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((unk_0xFC8BFE4B41177C22(uVar0[iVar1]) && !unk_0x4FAFF4BCB7633475(uVar0[iVar1])) && unk_0xE5E2AE8B19267B8A(uVar0[iVar1])) && func_76(uVar0[iVar1], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar1++;
