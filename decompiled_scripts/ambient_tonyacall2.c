...
int func_1()
{
	...
	if ((vdist2(Var0, Var1) > 10000f || unk_0x1C2F771CDC87A3A5(uLocal_38, 0)) || func_27())
	{
		return 1;
	}
	switch (iLocal_40)
		...
		case 0:
			if (unk_0xFC8BFE4B41177C22(uLocal_38) && !unk_0x1C2F771CDC87A3A5(uLocal_38, 0))
			{
				if (unk_0x65FFA94B82A71741(uLocal_38, Local_49, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					unk_0x4BD42B0527065BB6(uLocal_38, uVar3);
					unk_0xD0557B139A542F12(&uVar3);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0xFC8BFE4B41177C22(uLocal_38) && !unk_0x1C2F771CDC87A3A5(uLocal_38, 0))
			{
				if (unk_0x89EC60A4485FD199(uLocal_38) == 1)
				{
					if (!unk_0xFC8BFE4B41177C22(uLocal_39))
					{
						...
						{
							fVar4 = unk_0x82E64DE58A6B84A8(uLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar4 >= 0.157f)
							{
