...
void func_9()
{
	...
	{
		unk_0x4669032A1DFBB449(uLocal_208, sLocal_277, 1048576000);
	}
}
...
void func_104()
{
	...
	while (!unk_0xE100DD4F82A51BDE(sLocal_277))
	{
		wait(0);
	}
	iLocal_278 = 1;
...
void func_118()
{
	if (iLocal_278 == 1)
	{
		if (unk_0xE100DD4F82A51BDE(sLocal_277))
		{
			unk_0x268BE77F77533D03(sLocal_277);
		}
	}
}
