...
int func_2()
{
	...
	if (vdist(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Local_72) > 100f)
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_70[iParam1])
		{
			case 0:
				...
				if (unk_0x9B5C1660CCDF7189(iParam0, joaat("script_task_wander_standard")) != 1)
				{
					...
					unk_0x44FB298D6382876D(iLocal_68[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0xD6F9DEE4765092A9(&(Local_71[iParam1 /*4*/])))
				{
			...
			case 3:
				...
				if (vdist2(unk_0xD1A6A821F5AC81DB(iParam0, 1), unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)) > (50f * 50f))
				{
					iLocal_70[iParam1] = 0;
					return 1;
				}
...
void func_21()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			if (!unk_0xD6F9DEE4765092A9(&(Local_71[iVar0 /*4*/])))
			{
				unk_0x97A5024CE91641F1(&(Local_71[iVar0 /*4*/]));
				if (!unk_0xA6E4F7A73ABC4A76(&(Local_71[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0xB1DBFEB95C0EFB88(4, iLocal_69[iVar0], Local_72 + Local_74[iVar0 /*3*/], 0, 1, 1);
			unk_0x5C96CEA06531AB03(iLocal_68[iVar0], (fLocal_73 + fLocal_75[iVar0]));
			...
			unk_0x9FF00EA9A61211D2(iLocal_68[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_22()
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			Local_74[3 /*3*/] = { Vector(45.5004f, unk_0xD2AA6F822D3A55D2(-205.8167f, -210.4254f), unk_0xD2AA6F822D3A55D2(-1416.54f, -1428.501f)) - Local_72 };
