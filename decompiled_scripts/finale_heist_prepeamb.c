...
void func_139()
{
	...
	func_146();
	func_111();
	if (func_78(unk_0x4A8C381C258A124D(), Local_50, 150f, 1) && !unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, 0, 1, 0))
	{
		unk_0x60040CDD28AA1BC3(Local_50, 6f, 0, 1, 0, 0, 0, 0, 0);
	...
	if (!BitTest(uLocal_49, 18))
	{
		if (!func_15(0) && !func_119())
		{
			...
			unk_0x0B0C9A0F9AAEB7F0(&uLocal_49, 18);
		}
	}
	if (BitTest(uLocal_49, 0))
	{
		if (BitTest(uLocal_49, 1))
		{
			...
			if (func_87(iLocal_51))
			{
				if (!unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), iLocal_51, 0))
				{
					if (unk_0x1CE980E99A2A6FB6(iLocal_51))
					{
						func_141();
						func_140(&uLocal_246);
						func_93(35, 0);
	...
	{
		unk_0x8744D2E3FC95740E(&uLocal_49, 18);
		func_140(&uLocal_246);
		unk_0xA63572E348CC4CFB(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, 1, 1);
		func_80(0, 1);
	}
...
void func_146()
{
	...
	{
		case 0:
			if (((!unk_0xC450B06E5AAA0985(uLocal_245) && BitTest(uLocal_49, 0)) && !BitTest(uLocal_49, 1)) && BitTest(uLocal_49, 18))
			{
	...
	if (func_105(35))
	{
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_49, 1))
			{
				if (func_87(iLocal_51))
				{
					unk_0x65FFA94B82A71741(iLocal_51, Local_50, 4f, 4f, 2f, 1, 1, 0);
					if (unk_0x5105BE70DEF1F5FB(iLocal_51, -168.8162f, -619.9002f, 31.42446f, -162.6423f, -622.0781f, 33.42446f, 4.14f, 0, 1, 0))
					{
						func_152(24, 46);
			...
			{
				if (!func_78(iLocal_51, Local_50, 10f, 1) || unk_0xD1F1A906BA9226BE(iLocal_51))
				{
					unk_0x8744D2E3FC95740E(&uLocal_49, true);
				}
			}
								...
								if (!func_170(iVar0))
								{
									if (func_163(iVar0) && !func_162())
									{
										if (!unk_0x110821AE6C63DD4F(iVar0))
										{
											...
											{
												func_71(9);
												unk_0x0B0C9A0F9AAEB7F0(&uLocal_49, 19);
											}
...
void func_192(bool bParam0, var uParam1)
{
	...
	func_193(&uLocal_80, Local_44.f_0, unk_0x4A8C381C258A124D(), Local_44.f_1, 0, 1);
