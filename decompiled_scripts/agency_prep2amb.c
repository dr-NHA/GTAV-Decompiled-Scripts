		...
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_49, 1) && BitTest(uLocal_49, 0))
			{
				if (!func_78(unk_0x4A8C381C258A124D(), Local_50, 5f, 1))
				{
					...
					{
						if ((func_252(unk_0x4A8C381C258A124D()) && !BitTest(uLocal_47[0], 17)) && !BitTest(uLocal_47[1], 18))
						{
...
int func_207()
{
	if (vdist2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), 1276.123f, -1723.665f, 53.6551f) <= 52900f)
	{
		if (func_13())
		{
			func_71(30);
	...
	else if (vdist2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), 111.8564f, -751.7169f, 44.757f) <= 160000f)
	{
		if (func_13())
		{
			func_71(31);
