...
int func_189(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_180(2))
	{
		if (!func_151())
		{
			if (((func_132(unk_0x4A8C381C258A124D()) && func_132(uParam0->f_28[0])) && (unk_0x1DD05E817C89C737() - uParam0->f_60) > iParam6) && func_195(unk_0x4A8C381C258A124D(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_190(sParam3))
		{
			...
			{
				if (func_195(unk_0x4A8C381C258A124D(), Param1, 1) >= 20f)
				{
					func_149();
				}
			}
...
void func_196(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5)
{
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam2))
		{
			...
			{
				if (func_195(unk_0x4A8C381C258A124D(), Param3, 1) <= 100f)
				{
					func_199(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_195(unk_0x4A8C381C258A124D(), Param4, 1);
					fVar1 = func_195(unk_0x4A8C381C258A124D(), Param5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
				...
				if (func_195(unk_0x4A8C381C258A124D(), Param3, 1) > 120f)
				{
					func_200(iParam0);
				}
			}
...
int func_243(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (((!func_246(&iVar0) || !unk_0xE100DD4F82A51BDE("rcmlastone1")) || !unk_0x92A65766A892EFC6(joaat("weapon_pumpshotgun"))) || !unk_0x92A65766A892EFC6(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = unk_0xB1DBFEB95C0EFB88(25, iLocal_52, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
