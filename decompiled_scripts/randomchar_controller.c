				...
				if (!func_43(74))
				{
					...
					else if (func_23(iLocal_56))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (unk_0xC450B06E5AAA0985(Global_32543[iVar3 /*23*/].f_19))
								{
									unk_0x861AC9C2D48CEA7F(Global_32543[iVar3 /*23*/].f_19, 1);
									unk_0x8D777E1B885E428C(Global_32543[iVar3 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!func_45(35))
		{
			if (BitTest(Global_113648.f_18576[iParam0 /*6*/], 2) && !BitTest(Global_113648.f_18576[iParam0 /*6*/], 3))
			{
				...
				{
					if (vdist2(Var0.f_6, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)) < 81f)
					{
						sVar16 = "";
